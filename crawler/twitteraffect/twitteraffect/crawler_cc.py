...
POST_PARAMS = {'include_entities': 0,
               ...
               'stall_warning': 'true',
               #'track': ':),:-),:D,:-D'}
               'track': '#afraid,#terrified,#horrified,#petrified,#fearful,#paincky,#frantic, #apprehensive,#frightened,#threatened,#insecure,#uneasy,#cautious,#intimidated,#nervous,#worried,#timid,#anxious'}
