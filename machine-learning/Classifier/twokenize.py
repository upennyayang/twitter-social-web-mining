...
if __name__=='__main__':
  print u" ".join(tokenize("Lies will catch up to you...the cracks are already beginning to show:) #[someTAG] #[someTAG] #[someTAG] they said...we know better xoxo;)")).encode('utf-8')
