...
def create_feature_space_IG(n,bi):
	a={}
	#ig, gr, si = textgain.compute('IG_Bi')
...
def Training(directory,n,bi):
	...
	feature_space = create_feature_space_IG(n,bi)
	#print feature_space
	# try:
	...
	#svm_save_model('libsvm_SVC_IG.model', m1)
...
# [m, fs] = Training(Training_Path,500, bi)
